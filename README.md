...
```
cd existing_repo
git remote add origin https://gitlab.com/vensder/certs-n-status.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/vensder/certs-n-status/-/settings/integrations)
